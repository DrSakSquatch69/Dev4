...
namespace GAME {
	...
	bool AreEntitiesColliding(entt::registry& registry, entt::entity entity1, entt::entity entity2) {
		...
		auto& transform1 = registry.get<GAME::Transform>(entity1);
		auto& meshCollection1 = registry.get<GAME::MeshCollection>(entity1);
		auto& transform2 = registry.get<GAME::Transform>(entity2);
		auto& meshCollection2 = registry.get<GAME::MeshCollection>(entity2);
		...
		bool isWall1 = registry.all_of<GAME::Wall>(entity1);
		bool isWall2 = registry.all_of<GAME::Wall>(entity2);
	...
	void HandleCollision(entt::registry& registry, entt::entity entity1, entt::entity entity2) {
		...
		bool isPlayer1 = registry.all_of<GAME::Player>(entity1);
		bool isPlayer2 = registry.all_of<GAME::Player>(entity2);
		bool isEnemy1 = registry.all_of<GAME::Enemy>(entity1);
		bool isEnemy2 = registry.all_of<GAME::Enemy>(entity2);
		bool isBullet1 = registry.all_of<GAME::Bullet>(entity1);
		bool isBullet2 = registry.all_of<GAME::Bullet>(entity2);
		bool isWall1 = registry.all_of<GAME::Wall>(entity1);
		bool isWall2 = registry.all_of<GAME::Wall>(entity2);
		...
		if ((isPlayer1 && isWall2) || (isPlayer2 && isWall1)) {
			...
			auto& wallTransform = registry.get<GAME::Transform>(wallEntity);
	...
	void CheckCollisions(entt::registry& registry) {
		...
		auto collidableView = registry.view<GAME::Transform, GAME::MeshCollection, GAME::Collidable>();
