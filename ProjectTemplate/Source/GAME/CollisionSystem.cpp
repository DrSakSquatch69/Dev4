...
namespace GAME {
    ...
    bool CheckCollision(const GW::MATH::GOBBF& obb1, const GW::MATH::GMATRIXF& transform1,
        ...
        GW::MATH::GMatrix::MultiplyVectorF(obb1.center, transform1, worldCenter1);
        GW::MATH::GMatrix::MultiplyVectorF(obb2.center, transform2, worldCenter2);
    ...
    void UpdateColliderTransform(entt::registry& registry, entt::entity entity) {
        if (registry.all_of<Transform, MeshCollection>(entity)) {
            ...
            GW::MATH::GMatrix::MultiplyVectorF(meshCollection.collider.center, transform.matrix, worldPos);
